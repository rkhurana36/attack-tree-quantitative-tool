...
export default function GoalNode({ data }: { data: Data }) {
  const init = data.values ?? { min: 0.2, ml: 0.5, max: 0.9 };
  ...
  const [title, setTitle] = useState(data.label ?? "Goal");
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center" }}>
        ...
        />
          <div
  style={{
    background: "#f59e0b", // amber or gold for goal
    color: "white",
    padding: "3px 6px",
    borderRadius: 999,
    fontSize: 11,
